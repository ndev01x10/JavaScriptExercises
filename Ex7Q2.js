...
document.getElementById("memEntryForm").style.display="none";
}

//This function is to show the hidde entry form-----
function showMemEntryForm(){
    document.getElementById("memEntryForm").style.display="block";

function showElem() {
}

//This function is to toggle between hinding and showing DIV element-----
